...
@section('content')
    <div class="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="profile-view">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0">StarCode Kh</h3>
                                                <h6 class="text-muted">UI/UX Design Team</h6>
                                                <small class="text-muted">Web Designer</small>
                                                <div class="staff-id">Employee ID : FT-0001</div>
                                                <div class="small doj text-muted">Date of Join : 1st Jan
                                                    2013</div>
                                            ...
                                            <ul class="personal-info">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="text"><a href><span class="__cf_email__"
                                                                data-cfemail="a1cbcec9cfc5cec4e1c4d9c0ccd1cdc48fc2cecc">[email&#160;protected]</span></a></div>
                                                </li>
                                                <li>
                                ...
                                <div class="pro-edit"><a data-target="#profile_info"
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <div class="text">StarCode Kh</div>
                                        </li>
                                        <li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="project-members m-b-15">
                                        ...
                                        <ul class="team-members">
                                            <li>
                                                <a href="#" data-toggle="tooltip" title="StarCode Kh"><img alt
        ...
        <div id="emergency_contact_modal" class="modal custom-modal fade"
            role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
