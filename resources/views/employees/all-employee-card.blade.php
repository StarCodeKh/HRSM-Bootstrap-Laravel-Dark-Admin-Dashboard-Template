		...
		<div class="content container-fluid">
				...
				<div class="row align-items-center">
					...
					<div class="col-auto float-right ml-auto">
                        ...
                        <div class="view-icons">
                            <a href="{{ route('all-employee-card') }}" class="grid-view btn btn-link active">
                                <i class="fa fa-th"></i>
                            </a>
                            <a href="{{ route('all-employee-list') }}" class="list-view btn btn-link">
			...
			<div class="row staff-grid-row">
				<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
					...
					<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.html">StarCode Kh</a></h4>
