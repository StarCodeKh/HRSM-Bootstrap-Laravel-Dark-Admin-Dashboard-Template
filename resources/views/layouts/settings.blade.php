...
<html lang="en">
    <head>
        ...
        <title>Settings - {{ ucwords(str_replace('.', ' - ', Route::currentRouteName())) }}</title>
		<!-- Favicon -->
            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="{{ route('home') }}" class="logo">
						<img src="{{ URL::to('assets/img/logo2.png') }}" width="40" height="40" alt="">
					</a>
                </div>
				<!-- /Logo -->
				...
				<ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('profile/em-profile') }}">My Profile</a>
                ...
                <div class="dropdown mobile-user-menu">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="profile/em-profile">My Profile</a> 
                        <a class="dropdown-item" href="{{ route('logout') }}">Logout</a>
                    </div>
                </div>
                <!-- /Mobile Menu -->
